<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UyeOlBireysel.aspx.cs" Inherits="Proje.Dolabım.templated_brushwood.UyeOlBireysel" %>
    ...
    <form id="form1" runat="server">
        ...
        <table style="width: 450px; height: 100px;">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBox1" runat="server" Width="162px" TextMode="Email"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
        ...
        <table style="width: 450px; height: 100px;">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBox4" runat="server" TextMode="Number" Width="162px"></asp:TextBox>
        ...
        <table style="width: 450px; height: 100px;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBox6" TextMode="Password" runat="server" Width="162px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
